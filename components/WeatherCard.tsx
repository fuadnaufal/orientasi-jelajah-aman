...
export default function WeatherCard({ kota, suhu, tingkatAQI }: WeatherCardProps) {
    ...
    return (
        <View accessible accessibilityLabel={`Cuaca ${kota}, suhu ${suhu} derajat, kualitas udara ${tingkatAQI}`} style={{ padding: spacing.sedang, borderRadius: 8, backgroundColor: "#F4F7FA" }} >
